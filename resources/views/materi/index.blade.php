    ...
    <div class="container mx-auto px-6 py-8">
        ...
        <div class="text-center mb-8">
            <h1 class="text-4xl font-bold mb-4" style="color: #570C49;">
                <i class="fas fa-book-open mr-3"></i>Manajemen Materi
            </h1>
            <p class="text-gray-700 text-lg mb-6">Kelola semua materi pembelajaran dengan mudah dan aman</p>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-6 mb-8 border-t-4" style="border-color: #570C49;">
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-lg font-semibold text-gray-700">Total Materi Tersimpan</h3>
